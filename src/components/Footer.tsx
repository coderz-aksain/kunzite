...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-white/5">
      {/* CTA Band */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              {[Instagram, Youtube, Facebook].map((Icon, i) => (
                ...
                >
                  <Icon className="w-4 h-4 text-black group-hover:text-black" />
                </a>
              ))}
            </div>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-black hover:text-[#f59e0b] text-md transition-colors duration-200 flex items-center gap-2 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-black text-md">Brij vihar kankhal Haridwar Uttrakhand 249408</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-[#f59e0b] shrink-0" />
                <a href="tel:+919876543210" className="text-black hover:text-[#f59e0b] text-md transition-colors">
                  +91 78954 63211
                </a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="https://www.nexoraai.world/" className="text-black/80 hover:text-black text-xl transition-colors">
              Developed by <span className=" hover:text-[#f59e0b] transition-colors font-bold">Nexora.</span>
            </Link>
          </div>
        </div>
      </div>
