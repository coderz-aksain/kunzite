  ...
  return (
    <div className="">
      ...
      <section className="relative py-52 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 lg:px-8 mt-20">
          <p className="text-[#f59e0b] text-md font-semibold uppercase tracking-widest mb-4">
            Contact Us
          </p>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-black text-xs uppercase tracking-wider mb-1">{item.label}</p>
                    {item.href ? (
                      <a href={item.href} className="text-black text-md hover:text-[#f59e0b] transition-colors whitespace-pre-line">
                        {item.value}
                      </a>
                    ) : (
                      <p className="text-black text-md whitespace-pre-line">{item.value}</p>
                    )}
                  </div>
                </div>
              ))}
          ...
          <div className="lg:col-span-3">
            <div className="bg-black border border-white/5 rounded-3xl p-8 md:p-10">
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <button
                    ...
                    className="mt-8 bg-[#f59e0b] text-black px-6 py-3 rounded-full font-semibold hover:bg-[#fb923c] transition-colors text-md"
                  >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid md:grid-cols-2 gap-5">
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-md focus:outline-none focus:border-[#f59e0b]"
                      />
